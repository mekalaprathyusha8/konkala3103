...
const achievements = [
  ...
  { icon: Award, title: "1000+ Students Trained", subtitle: "Across all disciplines since 2014", color: "#8B1E2D", bg: "rgba(139,30,45,0.12)" },
  { icon: Star, title: "13+ Years of Excellence", subtitle: "Established & trusted since 2014", color: "#B7323C", bg: "rgba(183,50,60,0.12)" },
...
const AchievementsSection = ({ hideHeader }: { hideHeader?: boolean } = {}) => {
  ...
  return (
    ...
    >
      {/* Decorative circles */}
      <div style={{ position: "absolute", top: "5%", left: "3%", width: 320, height: 320, borderRadius: "50%", border: "1px solid rgba(139,30,45,0.08)", pointerEvents: "none" }} />
      <div style={{ position: "absolute", bottom: "5%", right: "3%", width: 240, height: 240, borderRadius: "50%", border: "1px solid rgba(139,30,45,0.1)", pointerEvents: "none" }} />
          ...
          {achievements.map((a, i) => (
            <motion.div
              ...
              style={{
                ...
                boxShadow: "0 4px 24px rgba(139,30,45,0.06)",
            ...
            >
              ...
              <h3 style={{ color: "#2E0A12", fontFamily: "Playfair Display, serif", fontSize: "1.1rem", fontWeight: 700, marginBottom: 8, lineHeight: 1.3 }}>{a.title}</h3>
              <p style={{ color: "#777", fontSize: "0.82rem", fontFamily: "Poppins, sans-serif" }}>{a.subtitle}</p>
            </motion.div>
          ))}
        </div>
      </div>
